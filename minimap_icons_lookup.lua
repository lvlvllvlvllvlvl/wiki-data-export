local data = {
	...
	Sentinel = 596, 
	SentinelLocker = 597, 
	LakeStampingDevice = 598, 
	LakeReflectionDevice = 599, 
	Sanctum = 600, 
	SanctumDeferral = 601, 
	SanctumPact = 602, 
	SanctumFountain = 603, 
	SanctumRelicCorruptionDevice = 604, 
	SanctumMap = 605, 
	SanctumRelicAltar = 606, 
	SanctumRelicLocker = 607, 
	Crucible = 608, 
	CrucibleForge = 609, 
	AncestralChieftainKiloava = 610, 
	AncestralChieftainAkoya = 611, 
	AncestralChieftainMaata = 612, 
	AncestralChieftainRakiata = 613, 
	AncestralChieftainKahuturoa = 614, 
	AncestralChieftainAhuana = 615, 
	AncestralChieftainKaom = 616, 
	AncestralChieftainNavali = 617, 
	AncestralChieftainUtula = 618, 
	AncestralChieftainTawhanuku = 619, 
	AncestralChieftainIkiaho = 620, 
	AncestralArenaEntrance = 621, 
	AncestralEnemyChieftainTotem = 622, 
	AncestralAllyChieftainTotem = 623, 
	AncestralAllyChieftainTotemAttacked = 624, 
	AncestralFieldItem = 625, 
	AncestralEnemyTotem = 626, 
	AncestralAllyTotem = 627, 
	AncesltralAllyTotemAttacked = 628, 
	AncestralEnemyChieftainTotemAttacked = 629, 
	AncesltralEnemyTotemAttacked = 630, 
	WardenTrackerUniqueMonster = 631, 
	WardenTrackerRareMonster = 632, 
	AzmeriWoodsEntrance = 633, 
	ValdoChest = 634, 
	NecropolisCorpse = 635, 
	NecropolisLocker = 636, 
	Strongbox = 637, 
	CorpseTypeUndead = 638, 
	CorpseTypeHumanoid = 639, 
	CorpseTypeEldritch = 640, 
	CorpseTypeDemon = 641, 
	CorpseTypeConstruct = 642, 
	CorpseTypeBeast = 643, 
	OreTypeVerisium = 644, 
	OreTypePetrifiedWood = 645, 
	OreTypeDemonCopper = 646, 
	OreTypeCrimsonIron = 647, 
	OreTypeBismuth = 648, 
	VillageMining = 649, 
	VillageFarming = 650, 
	VillageSmelting = 651, 
	VillageDisenchanting = 652, 
	VillageShipping = 653, 
	VillageMapping = 654, 
	VillageTavern = 655, 
	VillageRecombinating = 656, 
	VillageRunesmithing = 657, 
	VillageMapDevice = 658, 
	VillageFarmingPlot = 659, 
	RacetrackCyanRhoa = 660, 
	RacetrackPurpleRhoa = 661, 
	RacetrackYellowRhoa = 662, 
	RacetrackRedRhoa = 663, 
